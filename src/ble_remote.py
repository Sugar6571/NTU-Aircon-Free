...
class BleRemote:
    def __init__(self, name, get_state, handle_command, sync_commands=None):
        ...
        self.sync_commands = sync_commands or ['{"get":"state"}']
    ...
    def tick(self, now_ms):
        ...
        if self.sync_status:
            self.sync_status = False
            self.sync_queue = list(self.sync_commands)
        if self.sync_queue:
